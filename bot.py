...
# This is By @STBOTZ
from stbotz.forcesub import force_sub, force_sub
...
def a(client, message):
    ...
    try:
        ...
        rep = f'🎶 <b>Title:</b> <a href="{link}">{title}</a>\n⌚ <b>Duration:</b> <code>{duration}</code>\n📻 <b>Uploaded By:</b> <a href="https://t.me/STBOTZHELP"> Song Bot</a>'
        ...
        m.edit('**An internal Error Occured, Report This @STBOTZHELP!!**')
        print(e)
    try:
